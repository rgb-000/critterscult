...
export const scene_02 = {
  ...
  alink: "https://loopchronicles.app",
    ...
    description2: ", as well as through various art creations that will promote the project and grow the community like the Critters Cult: Spin-offs and the Fantasy Series. Additionally, new developments will be made to expand the lore, narrative, and worldbuilding of the Crittersverse through the Critters Book, a collaborative compendium where players can add their own lore to their Critters, and The Library, the official source of information about the Critterverse. All of these elements will serve as source material and be used in the worldbuilding for the next collection, Suns:Saga, which will pushes the narrative and complexity of Critters Cult even further. For more information on these developments, check the ",
    alink2: "https://sunsstudio.com/artmap_3.0.pdf",
    linktext2: "ArtMap 3.0",
  description3: ".",
  buttonLabel: "",
  imgStart: false,
